...
CREATE TABLE `Game` (
  ...
  `SoloStats` text NOT NULL,
  `MultiStats` text NOT NULL,
...
INSERT INTO `authcookieremember` VALUES (4,1,'1=-=-934317f425843979fbd12a3e62ecd16caaafab8bd4ed0271abe3b80c9fd49537356a192b7913b04c54574d18c28d46e6395428ab',1550438403);
...
INSERT INTO `authsess` VALUES (4,1,'1=-=-e87430a94a77274f40afb060aad932513d7ff34a18b62d8d8131577da99b0797356a192b7913b04c54574d18c28d46e6395428ab','88.139.79.108','4sj8i5uofd1m52lq0aiiq00tc7',1524502865),(5,2,'2=-=-708c69164c82f135127f6719a5bbaa507561167992681b1b98368443466fb284da4b9237bacccdf19c0760cab7aec4a8359010b0','90.13.129.172','2ghutlfmq3gi7k2bdisckv5cb2',1524502246);
...
INSERT INTO `download` VALUES (1,'88.139.79.108'),(2,'163.5.141.15'),(3,'163.5.141.7'),(4,'163.5.141.253'),(5,'163.5.141.7'),(6,'163.5.141.7'),(7,'163.5.141.7'),(8,'163.5.141.7'),(9,'163.5.141.79'),(10,'163.5.141.79'),(11,'163.5.141.79'),(12,'163.5.141.79'),(13,'163.5.141.79'),(14,'163.5.141.79'),(15,'163.5.141.79'),(16,'163.5.141.7'),(17,'163.5.141.7'),(18,'163.5.141.7'),(19,'163.5.141.79'),(20,'163.5.141.253'),(21,'45.79.218.22');
...
--
-- Dumping data for table `gamesess`
--

LOCK TABLES `gamesess` WRITE;
/*!40000 ALTER TABLE `gamesess` DISABLE KEYS */;
/*!40000 ALTER TABLE `gamesess` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `user` VALUES (1,'I3lock','FARINAZZO','Cédric','cedric.farinazzo@epita.fr','a99885e8ab226ebf4604b741113db99dd9c3ff8097301f143cd9bca32bd5bfc232007d851d2ecd0936ff0e7504551f28d45867b7b291acff506518c5a406872c','2018-02-16 19:18:55','5','chef de projet','webmaster'),(2,'Bob','Claudel','Antoine','antoine.claudel@hotmail.fr','c1f7b255974d4138524754937a79ae3bbc705ddf579ff4679cc48ecaf348610b4ddafc4bade4f22bf81c411b11b6232f85113237c6a2fb7d645b09e4063e48a1','2018-02-23 14:07:41','6','Le plus beau des beau gosses sur Terre','admin'),(3,'Bob','Grizzi','Edgar','edgar.grizzi@epita.fr','37a4e3a4a39bfa7fe3f922ecde33b1ebff8d920c3949686b7af9660a0a120f00957aaeaa3a126dd6b785ec0a5f3bdee3d57c5ea61da5ba4485dcc54a50ffc518','2018-03-13 19:56:21','2',NULL,'admin'),(4,'test','test','test','test@gmail.com','ee26b0dd4af7e749aa1a8ee3c10ae9923f618980772e473f8819a5d4940e0db27ac185f8a0e1d5f84f88bc887fd67b143732c304cc5fa9ad8e6f57f50028a8ff','2018-03-29 18:45:35','2',NULL,'user'),(8,'test43','test42','test42','test42@gmail.com','df6b9fb15cfdbb7527be5a8a6e39f39e572c8ddb943fbc79a943438e9d3d85ebfc2ccf9e0eccd9346026c0b6876e0e01556fe56f135582c05fbdbb505d46755a','2018-04-23 18:09:37','2','Je suis un test \r\nPeut etre ...','user');
...
-- Dump completed on 2018-04-24 12:18:14
