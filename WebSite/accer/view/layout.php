			...
			<header>
				...
				<nav class="red accent-4">
					<div class="container nav-wrapper">
						<a href="?p=accueil" class="brand-logo">ACCEr<img class="responsive-img" src="<?= URL_PATH.'/image.php?img='.urlencode($accer_logo).'&larg=90'; ?>"  alt="accer-logo"></a>
					...
					<div class="row">
						<div class="col l6 s12">
							...
							<p class="grey-text text-lighten-4">
								<?= ORGANIZATION_NAME ?> est un groupe d'étudiant en première année d'EPITA Strasbourg.
							</p>
						</div>
