...
ob_start();
?>
	<h2 class="center">Conditions générales d'utilisation du site ACCEr</h2>
	<div class="divider"></div>
	<br/>
	
	<div class="containe article-container">
		<div class="article-1">
			<h4 class="center">ARTICLE
			1 : Objet</h4>
			<p>
		...
		<div class="article-2">
			<h4 class="center">ARTICLE
			2 : Mentions légales</h4>
			<p>
			L'édition du site accer.ddns.net est
			assurée par le groupe ACCEr situé à Strasbourg (FRANCE).
			</p>
			<p>
			L'hébergement du site ACCEr est assuré par 
			Cédric Farinazzo à Strasbourg.
			</p>

		</div>
		<div class="article-3">
			<h4 class="center">ARTICLE 3 :
			Définitions</h4>
			<ul>
				<li><p>
				Utilisateur : ce terme désigne toute personne qui utilise le
				site ou l'un des services proposés par le site.
				</p></li>
				<li><p>Contenu
				utilisateur : ce sont les données transmises par l'Utilisateur
				au sein du site.</p></li>
				<li><p>Membre :
				l'Utilisateur devient membre lorsqu'il est identifié sur le site.</p></li>
				<li><p>Identifiant
				et mot de passe : c'est l'ensemble des informations nécessaires
				à l'identification d'un Utilisateur sur le site. L'identifiant (l'email) et
		...
		<div class="article-6">
			<h4 class="center">ARTICLE 6 :
			Responsabilité et force majeure</h4>
			<p>
		...
		<div class="article-7">
			<h4 class="center">ARTICLE 7 :
			Liens hypertextes</h4>
			<p>
			...
			responsabilité de ACCEr qui n'a
		...
		<div class="article-8">
			<h4 class="center">ARTICLE 8 :
			Évolution du contrat</h4>
			<p>
