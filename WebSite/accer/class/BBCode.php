...
abstract class BBCode
{
	public static function BBCodeGetEditor ($aName, $aTxt, $aButtonLst='' , $row = 0, $col = 0)
	{
		...
		$tag['color'] = array('id'=>'bbcode2', 'title'=>'Couleur', 'type'=>'select', 'option'=>[ 	['title'=>'Couleur', 'value'=>''], 	['title'=>'Rouge', 'value'=>'#ff0000'], 	['title'=>'Vert', 'value'=>'#00ff00'], 	['title'=>'Bleu', 'value'=>'#0000ff'] 	], 'tag1'=>'[color=$1]', 'tag2'=>'[/color]'); 	$tag['bold'] = array('id'=>'bbcode3', 'title'=>'Gras', 'type'=>'button', 'tag1'=>'[b]', 'tag2'=>'[/b]');
