...
class ImageManager {
	...
	protected $img_folder = WEB_PATH.'/data/image/';
	protected $db;
	...
	public function redimUp($NouvelleLargeur = 200) 
	{
		switch($this->extension) {
			case "gif": $this->img = imagecreatefromgif($this->img_path); break;
			case "png": $this->img = imagecreatefrompng($this->img_path); break;
			case "jpeg": $this->img = imagecreatefromjpeg($this->img_path); break;
			case "jpg": $this->img = imagecreatefromjpeg($this->img_path); break;
			default:
				return false;
		}
	...
	private function display()
	{
		...
		if ($this->img_path != NULL && $this->img != NULL) {
			...
			switch($this->extension) {
				case "gif": return imagegif ($this->imgredim); break;
				case "png": return imagepng ($this->imgredim); break;
				case "jpeg": return imagejpeg ($this->imgredim); break;
				case "jpg": return imagejpeg ($this->imgredim); break;
				default:
			}
		}
		return false;
